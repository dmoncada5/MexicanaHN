...
import { facturaEncabezado, notacreditoEncabezado, notacreditoDetalle } from '../interfaces/interfaces';
import { format } from 'date-fns';
import { environment } from '../../../../environments/environment';
@Injectable({
  providedIn: 'root'
})
export class NotaCreditosService {
  onProductsChanged: BehaviorSubject<any>;
  notacreditos: notacreditoEncabezado[];
...
API_URI = environment.ipKey;
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> | Promise<any> | any
  {
      return new Promise<void>((resolve, reject) => {
          ...
          Promise.all([
              ...
              this.getnotacreditos('/notacredito/todo', 'NOTACREDITO')
  ...
  getnotacreditos(url: string, documento: string): Promise<any>
  {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http.post(`${this.API_URI}` + url, body, {headers: headers} )
              .subscribe((response: any) => {
                  this.notacreditos = response;
       
                  this.onProductsChanged.next(this.notacreditos);
                  resolve(response);
              }, reject);
      });
  }
 ...
 updatenotacreditoEncabezado(cotizacion: any): Promise<any>
 {
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/notacredito/Encabezado', cotizacion)
             .subscribe((response: any) => {
                   resolve(response);
             }, reject);
     });
 }
 updatestatus(cotizacion: any): Promise<any>
 {
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/notacredito/Encabezado', cotizacion)
             .subscribe((response: any) => {
 ...
 updatenotacreditoDetalle(cotizacion: any): Promise<any>
 {

        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/notacredito/Detalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
 ...
 updatestatusC(DocNum: number, status: string): Promise<any>
 {
        return new Promise((resolve, reject) => {
          ...
          this.http.put(`${this.API_URI}` + '/factura/statusC', body, {headers: headers})
             .subscribe((response: any) => {
                   resolve(response);
             }, reject);
     });
 ...
 addnotacreditoEncabezado(cotizacion: any): Promise<any>
 {

        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/notacredito/postearEncabezado', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
 }
addnotacreditoDetalle(cotizacion: any): Promise<any>
 {

        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/notacredito/postearDetalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
 ...
 DeletenotacreditoDetalle(DocNum: number)
 {
    return this.http.delete(`${this.API_URI}` + '/notacredito' + `/${DocNum}`);
 }
}
