...
export class EntradasComponent implements OnInit {
  ...
  cztEncabezado: entradaEncabezado = {
    DocNum: null,
    fechaDoc: null,	
    comentarios: null,
    LastUpdate: null,	 
  ...
  constructor(private entradasServices: EntradasService,
   ...
   ngOnInit(): void {
    ...
    this.dataSource = new FilesDataSource(this.entradasServices, this.paginator, this.sort);
        ...
        .subscribe(response => {
            ...
            switch ( actionType )
            {
                ...
                case 'seleccion':
                  ...
                  this.router.navigate(['ventas/entradas/' + formData.numero + '/' + 'ordencompra']);
...
export class FilesDataSource extends DataSource<any>
{
     ...
     */
    constructor(
        private entradasServices: EntradasService,
    ...
    )
    {
        ...
        this.filteredData = this.entradasServices.entradas;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.entradasServices.onProductsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.entradasServices.entradas.slice();
