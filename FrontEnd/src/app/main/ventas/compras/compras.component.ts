...
constructor(private comprasServcies: ComprasService,
        ...
        .subscribe(response => {
            ...
            switch ( actionType )
            {
                ...
                case 'seleccion':
                  ...
                  this.router.navigate(['ventas/compras/' + formData.numero + '/' + 'ordencompra']);
...
// console.log("selecc",formData.getRawValue());
  ...
  export class FilesDataSource extends DataSource<any>
  {
       ...
       */
      constructor(
          private comprasServcies: ComprasService,
