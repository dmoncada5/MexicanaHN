...
import { BuscarCService} from './buscar-c.service'
...
@Component({
  selector: 'app-buscarcotizacion',
  templateUrl: './buscarcotizacion.component.html',
  styleUrls: ['./buscarcotizacion.component.scss'],
...
filter: ElementRef;
  ...
  constructor(  public matDialogRef: MatDialogRef<BuscarcotizacionComponent>,
     @Inject(MAT_DIALOG_DATA) private _data: any,
  private   ServicioBuscar: BuscarCService,
...
//     this.ServicioBuscar.getpedidos("/pedido").then((res)=>{
...
export class FilesDataSource extends DataSource<any>
{
    ...
    constructor(
        private CotizacionesService: BuscarCService,
    ...
    )
    {
        ...
        this.filteredData = this.CotizacionesService.cotizacion;
    ...
    connect(): Observable<any[]>
    {
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.CotizacionesService.cotizacion.slice();
