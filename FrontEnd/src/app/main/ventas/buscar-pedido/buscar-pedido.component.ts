...
@Component({
  ...
  styleUrls: ['./buscar-pedido.component.scss'],
...
filter: ElementRef;
  ...
  constructor(  public matDialogRef: MatDialogRef<BuscarPedidoComponent>,
...
export class FilesDataSource extends DataSource<any>
{
    ...
    constructor(
        private PedidosService: BuscarPService,
    ...
    )
    {
        ...
        this.filteredData = this.PedidosService.pedidos;
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.PedidosService.onProductsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.PedidosService.pedidos.slice();
