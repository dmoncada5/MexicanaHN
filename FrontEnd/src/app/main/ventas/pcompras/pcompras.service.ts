...
import { pcompraEncabezado, pcompraDetalle} from '../interfaces/interfaces';
import { format } from 'date-fns';
import { environment } from '../../../../environments/environment';
@Injectable({
  providedIn: 'root'
})
export class PComprasService {
  onProductsChanged: BehaviorSubject<any>;
  pcompras: pcompraEncabezado[];
pedidosD: pcompraDetalle[];
...
API_URI = environment.ipKey;
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> | Promise<any> | any
  {
      return new Promise<void>((resolve, reject) => {
          ...
          Promise.all([
              ...
              this.getPCompras('/pcompra/todo', 'ORDENCOMPRA')
  ...
  getPCompras(url: string, documento: string): Promise<any>
  {
 ...
 {
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/pcompra/Encabezado', cotizacion)
             .subscribe((response: any) => {
                   resolve(response);
             }, reject);
     });
 ...
 updatepedidoDetalle(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/pcompra/Detalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
 ...
 addpedidoEncabezado(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/pcompra/postearEncabezado', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
...
addpedidoDetalle(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/pcompra/postearDetalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
...
updatestatusC(DocNum: number|string, status: string): Promise<any>
{
       return new Promise((resolve, reject) => {
         ...
         this.http.put(`${this.API_URI}` + '/pcompra/statusP', body, {headers: headers})
            .subscribe((response: any) => {
                  resolve(response);
            }, reject);
    });
...
updateCorrelativo(cnum: number): Promise<any>
{
 ...
 {
    return this.http.delete(`${this.API_URI}` + '/pcompra' + `/${DocNum}`);
 }
}
