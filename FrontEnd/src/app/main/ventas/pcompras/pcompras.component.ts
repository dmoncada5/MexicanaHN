...
import { PComprasService } from './pcompras.service';
...
@Component({
  ...
  styleUrls: ['./pcompras.component.scss'],
...
export class PComprasComponent implements OnInit {
  ...
  cztEncabezado: pcompraEncabezado = {
    DocNum: null,
    fechaDoc: null,	
    SocioCode: null,
    NombreSocio: null,
  ...
  constructor(private pcomprasServices: PComprasService,
   ...
   ngOnInit(): void {
    ...
    this.dataSource = new FilesDataSource(this.pcomprasServices, this.paginator, this.sort);
        ...
        .subscribe(response => {
            ...
            switch ( actionType )
            {
                ...
                case 'seleccion':
                  ...
                  this.router.navigate(['ventas/pcompras/' + formData.numero + '/' + 'ordencompra']);
...
export class FilesDataSource extends DataSource<any>
{
     ...
     */
    constructor(
        private pcomprasServices: PComprasService,
    ...
    )
    {
        ...
        this.filteredData = this.pcomprasServices.pcompras;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.pcomprasServices.onProductsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.pcomprasServices.pcompras.slice();
