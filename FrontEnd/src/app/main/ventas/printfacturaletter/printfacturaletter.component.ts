...
@Component({
  selector: 'app-printfacturaletter',
  templateUrl: './printfacturaletter.component.html',
  styleUrls: ['./printfacturaletter.component.scss'],
  encapsulation: ViewEncapsulation.None

})
export class PrintfacturaletterComponent implements OnInit {
  Encabezado:any={
    TotalDoc:0
  };
  Detalle:any;
