...
API_URI = environment.ipKey;
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> | Promise<any> | any
  {
      return new Promise<void>((resolve, reject) => {
          ...
          Promise.all([
              ...
              this.getPedidos('/pedido/todo', 'PEDIDO')
  ...
  getPedidos(url: string, documento: string): Promise<any>
  {
 ...
 {
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/pedido/Encabezado', cotizacion)
             .subscribe((response: any) => {
                   resolve(response);
             }, reject);
     });
 ...
 updatepedidoDetalle(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/pedido/Detalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
 ...
 addpedidoEncabezado(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/pedido/postearEncabezado', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
...
addpedidoDetalle(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/pedido/postearDetalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
...
updatestatusC(DocNum: number|string, status: string): Promise<any>
{
 ...
 pedidoExistencia(url: string, id: number | string, cbod: number | string, cantidad: number) {
  let headers = new HttpHeaders();
  headers = new HttpHeaders().set('Content-Type', 'application/json');
  const body = JSON.stringify({ItemCode: id, cbod: cbod, cantidad: cantidad});
  return new Promise((resolve, reject) => {
...
updateCorrelativo(cnum: number): Promise<any>
{
 ...
 {
    return this.http.delete(`${this.API_URI}` + '/pedido' + `/${DocNum}`);
 }
}
