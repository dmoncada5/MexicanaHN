...
import {pedidoEncabezado, pedidoDetalle} from '../interfaces/interfaces';
...
export class PedidosComponent implements OnInit {
  ...
  cztEncabezado: pedidoEncabezado = {
    DocNum: null,
    fechaDoc: null,	
    SocioCode: null,
    NombreSocio: null,
  ...
  constructor(private pedidoServcies: PedidosService,
   ...
   ngOnInit(): void {
    ...
    this.dataSource = new FilesDataSource(this.pedidoServcies, this.paginator, this.sort);
...
//         this.pedidoServcies.updatestatusC(DocNum,'C');
...
export class FilesDataSource extends DataSource<any>
{
     ...
     */
    constructor(
        private pedidoServcies: PedidosService,
