...
// import { BuscarPromoComponent } from '../buscar-promo/buscar-promo.component';
...
export class PromosComponent implements OnInit {
  displayedColumns = [ 'ItemCode', 'ItemName', 'FechaCreacion', 'estado'];
  cztEncabezado: promoEncabezado = {
    ItemCode: null,
    ItemName: null,
    FechaCreacion: null,
    impuesto: null,
  ...
  constructor(private promoServcies: PromosService,
   ...
   ngOnInit(): void {
    ...
    this.dataSource = new FilesDataSource(this.promoServcies, this.paginator, this.sort);
...
// //                   this.router.navigate(['ventas/promos/' + formData.numero + '/' + 'cotizacion']);
...
export class FilesDataSource extends DataSource<any>
{
     ...
     */
    constructor(
        private promoServcies: PromosService,
    ...
    )
    {
        ...
        this.filteredData = this.promoServcies.promos;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.promoServcies.onProductsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.promoServcies.promos.slice();
