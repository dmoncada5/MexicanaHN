...
import { BuscarOService} from './buscar-o.service'
...
filter: ElementRef;
  ...
  constructor(  public matDialogRef: MatDialogRef<BuscarOrdenComponent>,
                @Inject(MAT_DIALOG_DATA) private _data: any,
                private   ServicioBuscar: BuscarOService,
...
export class FilesDataSource extends DataSource<any>
{
    ...
    constructor(
        private PComprasService: BuscarOService,
    ...
    )
    {
        ...
        this.filteredData = this.PComprasService.pcompras;
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.PComprasService.onProductsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.PComprasService.pcompras.slice();
