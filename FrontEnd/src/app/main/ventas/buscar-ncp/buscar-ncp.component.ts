...
@Component({
  selector: 'app-buscar-ncp',
  templateUrl: './buscar-ncp.component.html',
  styleUrls: ['./buscar-ncp.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations   : fuseAnimations
})

export class BuscarNCPComponent implements OnInit {
...
filter: ElementRef;
  ...
  constructor(  public matDialogRef: MatDialogRef<BuscarNCPComponent>,
                @Inject(MAT_DIALOG_DATA) private _data: any,
                private   ServicioBuscar: BuscarPService,
...
export class FilesDataSource extends DataSource<any>
{
    ...
    constructor(
        private ComprasService: BuscarPService,
    ...
    )
    {
        ...
        this.filteredData = this.ComprasService.compras;
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.ComprasService.onProductsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.ComprasService.compras.slice();
