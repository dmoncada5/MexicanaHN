...
export class SalidasService {
  ...
  salidas: salidaEncabezado[];
pedidosD: salidaDetalle[];
...
API_URI = environment.ipKey;
  ...
  getSalidas(url: string, documento: string): Promise<any>
  {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http.post(`${this.API_URI}` + url, body, {headers: headers} )
              .subscribe((response: any) => {
                  ...
                  this.onProductsChanged.next(this.salidas);
                  resolve(response);
              }, reject);
      });
  }
 ...
 {
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/salida/Encabezado', cotizacion)
             .subscribe((response: any) => {
                   resolve(response);
             }, reject);
     });
 ...
 updatepedidoDetalle(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/salida/Detalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
 ...
 addpedidoEncabezado(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/salida/postearEncabezado', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
...
addpedidoDetalle(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/salida/postearDetalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
...
updatestatusC(DocNum: number|string, status: string): Promise<any>
{
       return new Promise((resolve, reject) => {
         ...
         this.http.put(`${this.API_URI}` + '/salida/statusP', body, {headers: headers})
            .subscribe((response: any) => {
                  resolve(response);
            }, reject);
    });
...
comprasExistencia(url: string, id: number | string, cbod: number, cantidad: number) {
 ...
 {
    return this.http.delete(`${this.API_URI}` + '/salida' + `/${DocNum}`);
 }
}
