...
export class EntregasComponent implements OnInit {
  ...
  constructor(private facturaServcies: EntregasService,
          ...
          .subscribe(response => {
              ...
              switch ( actionType )
              {
                  ...
                  case 'seleccion':
                    ...
                    this.router.navigate(['ventas/entregas/'+formData.numero+'/'+'pedido']);
                ...
                .subscribe(response => {
                    ...
                    switch ( actionType )
                    {
                        ...
                        case 'seleccion':
                          ...
                          this.router.navigate(['ventas/entregas/'+formData.numero+'/'+'cotizacion']);
                          //  this._contactsService.updateContact(formData.getRawValue());
      // console.log("selecc",formData.getRawValue());
...
export class FilesDataSource extends DataSource<any>
{
     ...
     */
    constructor(
        private facturaServcies: EntregasService,
