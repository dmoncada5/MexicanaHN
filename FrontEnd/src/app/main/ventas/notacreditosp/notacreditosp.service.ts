...
export class NotaCreditosPService {
  onProductsChanged: BehaviorSubject<any>;
  notacreditosp: notacreditoEncabezado[];
...
API_URI = environment.ipKey;
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> | Promise<any> | any
  {
      return new Promise<void>((resolve, reject) => {
          ...
          Promise.all([
              ...
              this.getnotacreditos('/notacreditop/todo', 'NOTACREDITOCOMPRA')
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http.post(`${this.API_URI}` + url, body, {headers: headers} )
              .subscribe((response: any) => {
                  this.notacreditosp = response;
       
                  this.onProductsChanged.next(this.notacreditosp);
                  resolve(response);
              }, reject);
      });
  }
 ...
 {
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/notacreditop/Encabezado', cotizacion)
             .subscribe((response: any) => {
                   resolve(response);
             }, reject);
     });
 ...
 updatenotacreditoDetalle(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.put(`${this.API_URI}` + '/notacreditop/Detalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
 ...
 updatestatusC(DocNum: number, status: string): Promise<any>
 {
        return new Promise((resolve, reject) => {
          ...
          this.http.put(`${this.API_URI}` + '/compra/statusC', body, {headers: headers})
             .subscribe((response: any) => {
                   resolve(response);
             }, reject);
     });
 ...
 addnotacreditoEncabezado(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/notacreditop/postearEncabezado', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
...
addnotacreditoDetalle(cotizacion: any): Promise<any>
 {
        ...
        return new Promise((resolve, reject) => {
         this.http.post(`${this.API_URI}` + '/notacreditop/postearDetalle', cotizacion)
             .subscribe((response: any) => {
              resolve(response);
             }, reject);
     });
 ...
 {
    return this.http.delete(`${this.API_URI}` + '/notacreditop' + `/${DocNum}`);
 }
}
