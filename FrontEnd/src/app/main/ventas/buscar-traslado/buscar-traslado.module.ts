...
import { BuscarTrasladoComponent } from './buscar-traslado.component';

@NgModule({
  declarations: [BuscarTrasladoComponent],
  imports: [
    CommonModule,
    MatSortModule,
    MatButtonModule,
...
export class BuscarTrasladoModule { }
