...
export class PaisesComponent implements OnInit {
  ...
  displayedColumns = ['cpais', 'pais', 'estado'];
  ...
  ngOnInit(): void {
    ...
    this.dataSource = new FilesDataSource(this.paisesServices, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this.paisesServices.products;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.paisesServices.onProductsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.paisesServices.products.slice();
