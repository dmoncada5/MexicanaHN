...
export class CompanysComponent implements OnInit {
  ...
  displayedColumns = [ 'ccomp', 'empresa', 'empresa_sociedad','sucursales', 'rtn', 'telefono','estado'];
  ...
  constructor(private companyService: CompanysService) {
    console.log(this.companyService.companys)
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this.companyService.companys;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.companyService.onProductsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.companyService.companys.slice();
