...
export class ProductsComponent implements OnInit {
    ...
    displayedColumns = ['ItemCode', 'ItemName', 'costo', 'estado'];
  ...
  ngOnInit(): void {
    this.dataSource = new FilesDataSource(this.productsServices, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this.productsServices.products;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.productsServices.onProductsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this.productsServices.products.slice();
