...
import {SaldoClienteComponent} from '../../Finanzas/saldo-cliente/saldo-cliente.component'
...
const routes = [
  {
      path     : 'reporte/saldocliente',
      component: SaldoClienteComponent,
      canActivate: [GuardallGuard],
  }];


@NgModule({
  declarations: [SaldoClienteComponent],
