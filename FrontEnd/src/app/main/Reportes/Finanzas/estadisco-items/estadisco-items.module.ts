...
const routes = [
  {
      path     : 'reporte/articulosVendidos',
      component:EstadiscoItemsComponent,
      canActivate: [GuardallGuard],
  }];


@NgModule({
  declarations: [EstadiscoItemsComponent],
  imports: [
    CommonModule,
  ...
  exports     : [
   EstadiscoItemsComponent
  ]
})
export class EstadiscoItemsModule { }
